...
class _database {
     ...
     */
    executeQueryColumn(sqlQuery: string): Promise<string[]> {
                ...
                if (this.config.technology.toLowerCase() == 'mysql') {
                    ...
                    if (Array.isArray(result.data)) {
                        for (const row of result.data) {
                            ...
                            if (lstProps.length) out.push(String(row[lstProps[0]]));
                        }
                    }
                }
                else if (this.config.technology.toLowerCase() == 'mssql') {
                    ...
                    if (Array.isArray(result.data)) {
                        for (const row of result.data) {
                            ...
                            if (Array.isArray(row) && row.length) out.push(String(row[0].value));
                        }
                    }
                }
                else if (this.config.technology.toLowerCase() == 'postgres') {
                    ...
                    if (Array.isArray(result.data)) {
                        for (const row of result.data) {
                            ...
                            if (Array.isArray(row) && row.length) out.push(String(row[0]));
                        }
                    }
                }
                else;
