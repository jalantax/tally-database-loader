...
(
 ...
 mobile nvarchar(64) not null default '',
...
(
 ...
 duty_head nvarchar(64) not null default '',
 rate decimal(9,4) default 0,
 rate_per_unit decimal(9,4) default 0,
 valuation_type nvarchar(64) not null default '',
